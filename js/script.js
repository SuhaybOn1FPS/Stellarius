document.addEventListener("DOMContentLoaded", () => {
  ...
  // ===============================
  // Last.fm Integration (1 track only)
  // ===============================
  const apiKey = "09f6d36674db4c07e36a1fa2c44a38f0"; // Your Last.fm API Key
  const username = "suhaybon1fps"; // Your Last.fm username
  ...
  async function loadNowPlaying() {
    ...
    try {
      ...
      // Ensure album art loads, fallback to placeholder
  ...
  loadNowPlaying();
  setInterval(loadNowPlaying, 30000); // Refresh every 30s

  // ===============================
  // Smooth Live Age Counter
  // ===============================
  const ageElement = document.getElementById("age");
  if (ageElement) {
    const birthday = new Date("2011-06-17"); // ISO format YYYY-MM-DD
    ...
    function updateAgeSmooth() {
      ...
      displayedAge += (age - displayedAge) * 0.1; // smooth transition
